...
public class StreamApiExamples {
    ...
    public void sortHighToLow(){
        ...
        top10.forEach(x -> System.out.println(x.getChangeRate()));
        System.out.println("========================================");
        //Assert.assertEquals(top10.get(0).getSymbol(),"BTC-USDT");
        int a = 9;
    }
    ...
    public void sortLowToHigh(){
        ...
        lowToHight.forEach(x -> System.out.println(x.getChangeRate()));
        System.out.println("========================================");
        int a =0;
    }
